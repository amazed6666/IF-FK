...
# 加载原始图像
raw_pil_image = Image.open('/root/autodl-tmp/IF-easy-webui/raw-image/raw-image-03.png').convert('RGB')
...
if_I.to_images((1-inpainting_mask)*img)[0].save(f'/root/autodl-tmp/IF-easy-webui/generate-imgs/04.oil-man_inpainting-mask-4.png')
...
for stage, images in result.items():
    for i, img in enumerate(images):
        img.save(f'/root/autodl-tmp/IF-easy-webui/generate-imgs/04.zero-short-inpainting_{stage}_{i}-4.png')